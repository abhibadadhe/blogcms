...
<body class="bg-white font-family-karla">
    ...
    <header class="w-full container mx-auto">
        <div class="flex flex-col items-center py-12">
            ...
            <p class="text-lg text-gray-600">
                {{ $setting?->description ?? 'Welcome to our website.' }}
            </p>
        </div>
    </header>
        ...
        @if (!request()->routeIs('page.show'))
            <aside class="w-full md:w-1/3 flex flex-col items-center px-3">
                ...
                <div class="w-full bg-white shadow flex flex-col my-4 p-6">
                    ...
                    <p class="pb-2">{{ $setting?->about ?? 'No about content available.' }}</p>
                </div>
                ...
                <div class="w-full bg-white shadow flex flex-col my-4 p-6">
                    ...
                    <div class="content flex justify-between py-2 w-full">
                        <div class="px-2 justify-between">Name</div>
                        <div class="justify-between">Posts Count</div>
                    </div>
    ...
    <footer class="w-full border-t bg-white pb-12">
        <div class="w-full container mx-auto flex flex-col items-center">
            ...
            <div class="uppercase pb-6">&copy; {{ $setting?->copy_rights ?? 'All rights reserved.' }}</div>
        </div>
    </footer>
